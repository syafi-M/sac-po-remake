    ...
    <div class="pt-[4.5rem] md:pt-20 w-full h-screen ">
        ...
        <div class="mt-5 div-news">
            ...
            <div class="w-full flex flex-col md:flex-row">
                @if ($video->count() > 0)
                    ...
                    @endphp
                    <div
                        class="bg-lime-600 w-full md:w-[40%] min-h-[220pt] md:h-auto rounded-b-md md:rounded-r-md md:rounded-bl-none flex overflow-x-scroll carousel">
                        @forelse ($video as $vid)
                            <div
                                class="flex flex-col pt-2 justify-start items-center w-full transition-all duration-300 ease-in-out carousel-item vidDiv">
                                <div
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="font-semibold capitalize text-white text-xs mdtext-sm">
                                        {{ $vid->description }}</p>
                                </div>
                            </div>
                        @empty
                ...
                @endif
                <div
                    class="beritaSlider w-full {{ $video ? ' md:w-[60%]' : '' }} relative z-[90] pt-[3vh] overflow-x-scroll overflow-y-hidden carousel rounded-md aspect-video">
                    @forelse ($artikel as $art)
                        <div class="carousel-item font-medium  transition-all duration-300 ease-in-out img-berita">
        ...
        <div class=" mt-5">
            ...
            <div class="clientSlider w-full carousel transition-all duration-300 ease-in-out px-[2.5svw]"
                style="height: 100%; max-height: 32svh;" id="scrollContainer">
                    ...
                    <div class="flex flex-col justify-around clientDiv carousel-item aspect-square px-[4svw] md:px-[0.5svw] transition-all duration-300 ease-in-out"
                        ...
                        <span class="flex justify-center items-center">
                            <img src="{{ asset('storage/images/' . $cli->img) }}" width="100"
                                class="rounded-md object-cover" alt="imeg1" loading="lazy" srcset="">
                        </span>
                        <p class="text-center font-semibold text-xs "
                            style="width: 100%; @media (min-width: 768px) { max-width: 5svw; } text-align: center;">
                            {{ $cli->name }}</p>
                    </div>
                @empty
                @endforelse
