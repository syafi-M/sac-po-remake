<footer class="bg-zinc-800 py-5 md:px-10 px-2">
    <div class="flex flex-col gap-2 items-center">
        ...
        <p class="text-white font-bold">PT. Surya Amanah Cendekia</p>
    </div>
    <div class="font-semibold text-white my-5 ">
        <div class="md:flex justify-between">
            ...
            <div class="flex flex-col gap-1 mt-5 md:mt-0">
                ...
                <p class="max-w-md">Jl. Budi Utomo No. 10, Ronowijayan, Kec. Ponorogo, Kabupaten Ponorogo, Jawa Timur,
                    63471</p>
                <iframe
        ...
        <div class="md:flex md:flex-row-reverse md:justify-around md:items-end">
            <div class="flex flex-col gap-1 mt-5 md:mt-0">
                <p>Copyright {{ Carbon\Carbon::now()->year }} <a href="{{ route('/') }}" class="text-amber-500">PT.
                        Surya Amanah Cendekia</a> All Right Reserved</p>
            ...
            <div class="flex flex-col gap-1 mt-5 md:mt-0">
                ...
                <div class="flex flex-col gap-2">
                    <a href="https://www.instagram.com/ptsacponorogo/" class="flex items-center gap-2">
                        <p><i class="ri-instagram-line bg-white font-medium text-zinc-700 p-1 rounded-full text-xl"></i>
                        </p>
                        <p> @ptsacponorogo</p>
                    </a>
                    <a href="https://wa.me/6282134360007" class="flex items-center gap-2">
                        <p class="bg-white font-medium text-zinc-700 p-1 px-2 rounded-full text-xl"><i
                                class="ri-phone-line "></i> / <i class="ri-whatsapp-line"></i></p>
